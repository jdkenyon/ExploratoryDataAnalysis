...
# Jeff Kenyon
#
# Since I'm turning this in late and receive no credit anyway, I'm not going to
# break out code for each plot to it's own file.

options(stringsAsFactors = FALSE)
options(scipen=100) 
options(width=100)

kRoot <- "C:/Development/R/Exploratory Data Analysis -- Coursera/"
